...
var EmailConfig = Config{
	En: map[string]string{
		...
		"content": "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\" /><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" /><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" /><title>Register for IT&TEA</title><style>body {font-family: Arial, sans-serif;  background-color: #f4f4f4;  color: #333;  padding: 20px;  text-align: center;}.container {max-width: 600px;  margin: 0 auto;  background-color: #fff;  padding: 20px;  border-radius: 8px;  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);}h1 {color: #114008;}p {font-size: 16px;  line-height: 1.5;}.button {display: inline-block;  background-color: #114008;  color: white;  text-decoration: none;  padding: 10px 20px;  border-radius: 5px;  font-size: 18px;  margin-top: 20px;}.button:hover {background-color: #176109;}</style></head><body><div class=\"container\"><h1>Welcome to IT&amp;TEA</h1><p>We're excited to have you join us! Please click the button below to register.</p><a href=\"https://www.it-t.xyz/create-account/{id}\" class=\"button\">Register Now</a><p>If you did not request this email, please ignore it.</p></div></body></html>",
	},
	Fr: map[string]string{
		"subject": "Bienvenue chez IT&TEA",
		"content": "<!DOCTYPE html><html lang=\"fr\"><head><meta charset=\"UTF-8\" /><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" /><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" /><title>Register for IT&TEA</title><style>body {font-family: Arial, sans-serif;  background-color: #f4f4f4;  color: #333;  padding: 20px;  text-align: center;}.container {max-width: 600px;  margin: 0 auto;  background-color: #fff;  padding: 20px;  border-radius: 8px;  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);}h1 {color: #114008;}p {font-size: 16px;  line-height: 1.5;}.button {display: inline-block;  background-color: #114008;  color: white;  text-decoration: none;  padding: 10px 20px;  border-radius: 5px;  font-size: 18px;  margin-top: 20px;}.button:hover {background-color: #176109;}</style></head><body><div class=\"container\"><h1>Bienvenue chez IT&TEA</h1><p>Nous sommes ravis de vous accueillir parmi nous ! Veuillez cliquer sur le bouton ci-dessous pour vous inscrire.</p><a href=\"https://www.it-t.xyz/create-account/{id}\" class=\"button\">Inscrivez-vous maintenant</a><p>Si vous n’avez pas demandé cet e-mail, veuillez l’ignorer.</p></div></body></html>",
	},
	Zh: map[string]string{
		"subject": "欢迎加入IT&TEA",
		"content": "<!DOCTYPE html><html lang=\"zh\"><head><meta charset=\"UTF-8\" /><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" /><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" /><title>Register for IT&TEA</title><style>body {font-family: Arial, sans-serif;  background-color: #f4f4f4;  color: #333;  padding: 20px;  text-align: center;}.container {max-width: 600px;  margin: 0 auto;  background-color: #fff;  padding: 20px;  border-radius: 8px;  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);}h1 {color: #114008;}p {font-size: 16px;  line-height: 1.5;}.button {display: inline-block;  background-color: #114008;  color: white;  text-decoration: none;  padding: 10px 20px;  border-radius: 5px;  font-size: 18px;  margin-top: 20px;}.button:hover {background-color: #176109;}</style></head><body><div class=\"container\"><h1>欢迎加入 IT&TEA</h1><p>我们很高兴你能加入我们！请点击下面的按钮进行注册。</p><a href=\"https://www.it-t.xyz/create-account/{id}\" class=\"button\">立即注册</a><p>如果您没有请求此邮件，请忽略它。</p></div></body></html>",
	},
}
